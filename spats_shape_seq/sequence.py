...
from spats_shape_seq.util import _debug, reverse_complement, align_strings, Indel, string_match_errors
...
class Sequence(object):
    ...
    def resolve_ambig_indels(self, target):
        ...
        prevind = -1
        seq = self.reverse_complement if self._needs_rc else self.subsequence
        for indind,indel in sorted(iter(self.indels.items())):
