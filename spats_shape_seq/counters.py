...
class Counters(object):
    ...
    def counts_dict(self):
        return { key : value for key, value in iter(self._counts.items()) if not key.startswith('_') }
